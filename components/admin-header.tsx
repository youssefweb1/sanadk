    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-sm">
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex-1 md:flex-initial">
          <h1 className="text-lg font-bold md:hidden">لوحة تحكم المسؤول</h1>
        </div>

        <div className="hidden md:flex items-center gap-4 flex-1 max-w-md">
          <div className="relative w-full">
            <Search className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
            <Input placeholder="بحث عن مطالبة أو طبيب..." className="pl-3 pr-10 rounded-full bg-muted border-none" />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <div className="max-h-[300px] overflow-auto">
                <DropdownMenuItem className="p-3 cursor-pointer">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">مطالبة جديدة</p>
                      <p className="text-xs text-muted-foreground">تم تقديم مطالبة جديدة من د. فاطمة محمد</p>
                ...
                <DropdownMenuItem className="p-3 cursor-pointer">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">قام د. خالد العتيبي بالاشتراك في المنصة</p>
              ...
              <DropdownMenuItem asChild className="justify-center">
                <Link href="/admin/notifications">عرض جميع الإشعارات</Link>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuLabel>المسؤول: عبدالله محمد</DropdownMenuLabel>
              <DropdownMenuSeparator />
